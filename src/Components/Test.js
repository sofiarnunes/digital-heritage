  ...
  return (
    <>
      ...
      <>
        ...
        <Canvas style={hover === true ? {height: '785px', width:'300px',  position: 'absolute', top: '-190px', left: '10px'} : {height: '785px', width:'300px',  position: 'absolute', top: '-190px', opacity: '0.7', left: '10px'}} >
          <OrbitControls enableZoom={false} />
          <ambientLight intensity={0.5} />
          <directionalLight position={[-2, 5, 2]} />
          <Suspense fallback={null}>
