  ...
  return (
    <>
      ...
      <>
        ...
        <Canvas style={hover === true ? {height: '710px', width:'300px',  position: 'absolute', top: '-210px', left:'-20px'} : {height: '710px', width:'300px',  position: 'absolute', top: '-210px', left:'-20px', opacity: '0.7'}} >
          <OrbitControls enableZoom={false} />
          <ambientLight intensity={0.5} />
          <directionalLight position={[-2, 5, 2]} />
          <Suspense fallback={null}>
